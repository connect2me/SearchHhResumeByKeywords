...
public class XMLConfiguration implements Configuration {
  ...
  public XMLConfiguration(InputStream src) throws GetHhResumeIdsByKeywordsException {
    if (src == null) throw new GetHhResumeIdsByKeywordsException("Не могу найти конфигурационного файла xml.");
    try {
      init(src);
    } catch(SAXException e) {
      throw new GetHhResumeIdsByKeywordsException("Не могу распарсить конфигурационный файл xml.");
    }catch(IOException e) {
      throw new GetHhResumeIdsByKeywordsException("Не могу распарсить конфигурационный файл xml.");
